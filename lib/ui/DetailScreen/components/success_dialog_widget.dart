            ...
            children: [
              ...
              Container(
                ...
                children: [
                  ...
                  Text("SUCCESS", style: Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.bold)  ),
                  SizedBox(height: 10.0),
                  Text("Item successfully added to cart", style: Theme.of(context).textTheme.bodyText2 ),
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal:CustomDimensions.defaultMargin),
