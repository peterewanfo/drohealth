...
class DetailsScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final existing_cart_detail = DrugRepository.getSingleCartDetail(shoppingCartModel.id.toString() );
                    ...
                    child: SingleChildScrollView(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: CustomDimensions.mediumSpacing),
                                              ...
                                              children: [
                                                InkWell(
                                                  onTap: (){
                                                    ...
                                                    int total = (int.parse(context.read(totalPacks).state)) + (int.parse(context.read(totalPacks).state) );

                                                    if( total > 0 ){

                                                      context.read(totalPacks).state = (total - 1).toString();
                                                ...
                                                Text(context.read(totalPacks).state),
                                                InkWell(
                                                  onTap: (){
                                                    
                                                    context.read(totalPacks).state = (int.parse(context.read(totalPacks).state) + 1).toString();
                      ...
                      child: CustomRectButton(
                        ...
                        onTap: () {
                          if(int.parse(context.read(totalPacks).state) < 1 ){
                            ...
                            Fluttertoast.showToast(msg: "Increase item before adding to bag");

                          }else{

                            shoppingCartModel.total_cart_items = context.read(totalPacks).state;
