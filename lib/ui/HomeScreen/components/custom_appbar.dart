...
class CustomAppBar extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.only(top:CustomDimensions.defaultMargin, bottom: CustomDimensions.smallSpacing /1.5, left: CustomDimensions.defaultMargin, right: CustomDimensions.defaultMargin),
      child: Column(
        children: [
          Row(
            children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: (){
                    context.read(searchOpenIndicatorProvider).state = !context.read(searchOpenIndicatorProvider).state;
                  },
                  child: Container(
                    padding: EdgeInsets.all(9.0),
                    decoration: BoxDecoration(
